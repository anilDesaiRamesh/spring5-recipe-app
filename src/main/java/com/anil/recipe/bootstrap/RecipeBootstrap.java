package com.anil.recipe.bootstrap;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
	...
	public void onApplicationEvent(ContextRefreshedEvent event) {
		log.debug("inside RecipeBootstrap---onApplicationEvent");
	...
	private List<Recipe> getRecipes() {
		...
		log.debug("inside RecipeBootstrap---before setting UOM");
		// get optionals
		...
		log.debug("inside RecipeBootstrap---after setting UOM");
		// get Categories
		...
		log.debug("inside RecipeBootstrap---after setting Recipe");
		// Yummy Guac
		...
		log.debug("inside RecipeBootstrap---after setting Note");
		...
		log.debug("inside RecipeBootstrap---before return");
		return recipes;
	}
}